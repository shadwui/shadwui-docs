...
const PreviewLayoutDesign = ({ children }: { children: React.ReactNode }) => {
  return (
    <div className="overflow-hidden px-4 supports-[overflow:clip]:overflow-clip sm:px-6 min-h-screen">
      <div
        className="
...
export default PreviewLayoutDesign;
